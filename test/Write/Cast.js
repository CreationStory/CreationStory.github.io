! function(e, t) {
    ...
    n.VantaBase = class {
        ...
        prepareEl() {
            ...
            for (e = 0; e < this.el.children.length; e++) t = this.el.children[e], "static" === getComputedStyle(t).position && (t.style.position = "absolute"), "auto" === getComputedStyle(t).zIndex && (t.style.zIndex = 1);
            "static" === getComputedStyle(this.el).position && (this.el.style.position = "absolute")
        }
        applyCanvasStyles(e, t = {}) {
            Object.assign(e.style, { display: "block" }), Object.assign(e.style, t), e.classList.add("Render")
        }
        initThree() {
